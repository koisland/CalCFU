...
class CalcConfig:
    ...
    INPUT_VALIDATORS = {
        ...
        "count": lambda count: isinstance(count, int) or isinstance(count, np.int64) and count >= 0,
        ...
        "num_plts": lambda num_plts: isinstance(num_plts, int) or isinstance(num_plts, np.int64) and num_plts > 0,
